...
describe('LoginUseCase', () => {
  ...
  describe('execute', () => {
    ...
    it('should login successfully with valid credentials', async () => {
      ...
      expect(mockUserRepository.getUserByEmail).toHaveBeenCalledWith(validCredentials.email);
    ...
    it('should throw error if email format is invalid', async () => {
      ...
      await expect(loginUseCase.execute(invalidEmailCredentials)).rejects.toThrow(
    ...
    it('should throw error if password is empty', async () => {
      ...
      await expect(loginUseCase.execute(emptyPasswordCredentials)).rejects.toThrow(
